...
<ul>
<li align="justify">Crie as planilhas e formulários necessários a partir dos exemplos contidos <a href="https://drive.google.com/drive/folders/1yZ6jJ9qG1GTLDjNK1zB1pefCNJmY2lFS?usp=sharing">na pasta compartilhada.</a> </li>
<li align="justify">Em seguida, terá que vincular os scripts. Para fazer isso, do formulário, clique nos três pontos no canto direito e clicque em editor de script. Da planilha, clique em extensões e depois em apps script.</li>
<li align="justify">Então copie os scripts para os editores, seguindo a seguinte ordem de vinculação:</li>
<ul>
<li align="justify">Script ConfirmacaoDeMatricula.gs para o formulário de comfirmação de matrícula.</li>
<li align="justify">Script IntencaoDeMatricula.gs e EmailTemplateIntencaoDeMatricula.html para o formulário de intenção de matrícula.</li>
<li align="justify">Script PlanilhaDeOferta.gs para a planilha de oferta didática.</li>
<li align="justify">Script DocumentacaoMatricula.gs e TemplateEmailDocumentacaoMatricula.html para o formulário de documentação de candidatos aprovados.</li>
<li align="justify">Script FormAlunoEspecial.gs e TemplateEmailFormAlunoEspecial.html para o formulário de inscrição de candidatos a aluno especial.</li>
<li align="justify">Script FormAlunoRegular.gs e TemplateEmailFormAlunoRegular.html para o formulário de inscrição de candidatos a aluno regular.</li>
</ul>
<li align="justify">Em seguida, crie os acionadores que chamaram a execução dos scripts:</li>
<ul>
<li align="justify">Na planilha de oferta didática, clique com o direito no botão atualizar, irá aparecer três pontos no botão. Clique nos três pontos e selecione a opção "transferir script" e então digite o nome da função a ser chamada pelo botão. Nesse caso é a função update (sem parênteses).</li>
<li align="justify">Para os outros casos, é necessário colocar acionadores automáticos. A partir do editor de script, clique em acionadores do lado esquerdo, depois em adicionar acionador.</li>
<ul>
<li align="justify">No formulário de intenção de matrícula, escolha a função "enviarEmail", origem do evento "do formulário" e o tipo do evento, "ao enviar o formulário".</li>
<li align="justify">No formulário de confirmação de matrícula, escolha a função "confirmar", origem do evento "do formulário" e o tipo do evento, "ao enviar o formulário".</li>
<li align="justify">Nos formulários de inscrição de candidatos a aluno regular e especial, escolha a função "moverArquivo", origem do evento "do formulário" e o tipo do evento, "ao enviar o formulário".</li>
<li align="justify">No formulário de documentação de candidatos aprovados, escolha a função "onFormSubmit", origem do evento "do formulário" e o tipo do evento, "ao enviar o formulário".</li>
</ul>
</ul>
<li align="justify">
Observação: O script do formulário de documentação de candidatos aprovados usa a biblioteca PDF-lib. Essa biblioteca possui uma linha de código que faz uma chamada à uma função que não existe no GAS. Um jeito de contornar isso é copiando a biblioteca em sua totalidade para um arquivo de script no seu editor (por exemplo pdf-lib.gs) e alterar o método chamado para um alternativo no GAS. Você encontra o que fazer em detalhes na discussão do github, <a href="https://github.com/Hopding/pdf-lib/discussions/1241">clicando aqui</a>.</li>
</ul>
</p align="justify">
