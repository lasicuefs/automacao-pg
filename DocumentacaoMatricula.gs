...
function onFormSubmit(e) {
  ...
  if (files.length > 0) {
    ...
    var subfolderURL = "https://drive.google.com/drive/folders/" + subfolder.getId() + "?usp=sharing";
     ...
     // verifica qual opção selecionada na pergunta sobre vagas reservadas (precisa ser a 3a pergunta)
...
function getSelectedChoiceIndex(e) {
  ...
  var mChoiceIndex = 3; //pergunta sobre vagas reservadas precisa ser a 4a pergunta!
